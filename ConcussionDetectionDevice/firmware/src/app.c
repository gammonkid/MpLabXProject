                ...
                switch(appData.receiveDataBuffer[0])
                {
                    ...
                    case 0x81:
                        ...
                        if(appData.hidDataTransmitted)
                        {
                            ...
                            int count=0;
                                while((count<=50||track%3!=0)&&valuestore[track]!=0)
                                {
                                    appData.transmitDataBuffer[count+2]=valuestore[track];
                                    appData.transmitDataBuffer[count+3]=(valuestore[track]>>8);
                                    valuestore[track]=0;
                                    if(track==192)
                                        track=0;
                                    count+=2;
                            ...
                            //int correction=count;
                            /*while(correction%3!=0)
                            {
                                //valuestore[track]=0;
                                track+=1;
                                if(track==192)
                            ...
                            appData.transmitDataBuffer[1]=count/3;
                        ...
                        {
                            /* Echo back to the host PC the command we are fulfilling in
                             * the first byte.  In this case, the Get LED State
                             * command. */
